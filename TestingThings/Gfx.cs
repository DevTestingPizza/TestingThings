...
namespace TestingThings
{
    class Gfx : BaseScript
    {
        ...
        {
            return x / Class1.ScreenWidth;
        }
        public static float GetY(float y)
        {
            return y / Class1.ScreenHeight;
        }
        ...
        public static async void DrawLobbyOverlay()
        {
            ...
            //RequestScaleformMovie("mp_matchmaking_card");
            //Scaleform t = new Scaleform("mp_matchmaking_card");
            //t.CallFunction("SET_TITLE", "Sumo V");
            //t.CallFunction("SET_DESCRIPTION", "500$", "0", "0", "Help string message.");
            //t.CallFunction("DISPLAY_VIEW", 0, 0);
            //RequestScaleformMovie("mp_results_panel");
            //Scaleform t = new Scaleform("mp_results_panel");
            //t.CallFunction("SET_TTTLE", "Sumo V");
            //t.CallFunction("SET_SUBTITLE", "Subtitle sumo.");
            //t.CallFunction("SET_SLOT", "sl", "1", "label");
                    ...
                    if (Game.IsDisabledControlJustPressed(0, Control.PhoneSelect))
                    {
                        ...
                        if (GridSelector.currentHoverIndex != 8 && GridSelector.currentHoverIndex != 6) // they did NOT press prev/next page.
                        {
                            if (GridSelector.currentHoverIndex == 7) // user confirmed their selection.
                            {
                                ...
                                Commands.TransitionToCoords(new Vector4(sp.X, sp.Y, sp.Z, heading), (uint)GetHashKey(GridSelector.GetSelectedItemName()));
